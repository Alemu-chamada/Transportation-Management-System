...
const getAllPosts = asyncHandler(async (req, res) => {
  ...
  return success(res, { message: "Posts retrieved successfully", data: { posts } });
});

const getPostById = asyncHandler(async (req, res) => {
  const post = await postService.getPostById(req.params.id, req.user.id);
  return success(res, { message: "Post retrieved successfully", data: { post } });
});
...
const createPost = asyncHandler(async (req, res) => {
  ...
  return success(res, { message: "Post created successfully", data: { post } });
});
...
const createComment = asyncHandler(async (req, res) => {
  ...
  return success(res, { message: "Comment created successfully", data: { comment } });
});
...
const toggleCommentLike = asyncHandler(async (req, res) => {
  const comment = await postService.toggleCommentLike({
    userId: req.user.id,
