...
const contacts = [
  {
    ...
    items: [
      ...
      { icon: Phone,  label: "System Phone", value: "+251 99 273 8116",               href: "tel:+251992738116" },
      { icon: MapPin, label: "Location",     value: "Addis Ababa Science and Technology University, Addis Ababa, Ethiopia" },
    ],
  },
  {
    category: "Developer",
    ...
    items: [
      ...
      { icon: MapPin,   label: "Institution", value: "ASTU · Computer Science & Engineering" },
    ],
  },
];
...
export function ContactPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link to="/contact" className="font-semibold text-sm" style={{ color: "#6366f1" }}>Contact</Link>
            </div>
      ...
      {/* Contact Cards — System on top-left, Developer on right */}
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* On mobile: stacked vertically (System first, Developer second).
              On md+: side by side. */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {contacts.map((group, gi) => (
              ...
              >
                {/* Colored header */}
                <div className="p-6 relative overflow-hidden" style={{ background: group.headerBg }}>
                  ...
                  {group.items.map((item) => (
                    <div key={item.label} className="flex items-start gap-4">
                      <div className="h-10 w-10 rounded-xl flex items-center justify-center flex-shrink-0"
                        ...
                        <item.icon className="h-4 w-4" style={{ color: group.iconAccent }} />
                      </div>
