    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        {buses.length === 0
          ...
          : <select value={formData.bus_id} onChange={e => handleChange("bus_id", e.target.value)}
      ...
      <div>
        ...
        {drivers.length === 0
          ...
          : <select value={formData.driver_id} onChange={e => handleChange("driver_id", e.target.value)}
              className="w-full px-4 py-3 rounded-xl bg-input-background border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-primary">
